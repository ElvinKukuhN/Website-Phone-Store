                    ...
                    <form action="" method="POST">
                        ...
                        <div class="text-center lg:text-left">
                            ...
                            <p class="text-sm text-white font-semibold mt-2 pt-1 mb-0">
                                ...
                                <a href="registeradmin.php" class="text-fuchsia-500 hover:text-fuchsia-600 focus:text-fuchsia-600 transition duration-200 ease-in-out">Sign Up</a>
                            </p>
                            <p class="text-sm text-white font-semibold mt-2 pt-1 mb-0">
                                You are User?
                                <a href="login.php" class="text-fuchsia-500 hover:text-fuchsia-600 focus:text-fuchsia-600 transition duration-200 ease-in-out">Login-User</a>
                            </p>
                        </div>
                    </form>
                </div>
