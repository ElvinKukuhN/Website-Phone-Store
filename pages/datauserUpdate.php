...
$data = mysqli_query($conn, "SELECT * FROM data_diri WHERE id_data_diri='$id' ");
                ...
                <div class="flex justify-between">
                    <div class="flex space-x-7">
                        ...
                        <div class="hidden md:flex items-center space-x-1">
                            ...
                            <a href="" class="py-4 px-2 text-white font-semibold hover:text-fuchsia-500 transition duration-300">User-data</a>
            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                ...
                <div class="mt-5 md:mt-0 md:col-span-2 shadow-2xl shadow-white">
                    <form action="update.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" value="<?php echo $d['id_data_diri']; ?>" name="id">
                            ...
                            <div class="px-4 py-5 bg-pink-400  sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" name="first-name" id="first-name" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 bg-pink-300 rounded-md" value="<?php echo $d['first_name'] ?>">
                                    </div>

                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="last-name" class="block text-sm font-medium text-white">Last name</label>
                                        <input type="text" name="last-name" id="last-name" autocomplete="family-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 bg-pink-300 rounded-md" value="<?php echo $d['last_name'] ?>">
                                    </div>

                                    <div class="col-span-6 sm:col-span-4">
                                        <label for="email-address" class="block text-sm font-medium text-white">Email address</label>
                                        <input type="text" name="email" id="email-address" autocomplete="email" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 bg-pink-300 rounded-md " value="<?php echo $d['email'] ?>">
                                    </div>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input type="text" name="street-address" id="street-address" autocomplete="street-address" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 bg-pink-300 rounded-md " value="<?php echo $d['address'] ?>">
                                    </div>

                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                        <label for="city" class="block text-sm font-medium text-white">City</label>
                                        <input type="text" name="city" id="city" autocomplete="address-level2" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 bg-pink-300 rounded-md" value="<?php echo $d['city'] ?>">
                                    </div>

                                    <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                        <label for="region" class="block text-sm font-medium text-white">State / Province</label>
                                        <input type="text" name="region" id="region" autocomplete="address-level1" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 bg-pink-300 rounded-md" value="<?php echo $d['province'] ?>">
                                    </div>

                                    <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                        <label for="postal-code" class="block text-sm font-medium text-white">ZIP / Postal code</label>
                                        <input type="text" name="postal-code" id="postal-code" autocomplete="postal-code" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 bg-pink-300 rounded-md" value="<?php echo $d['postal_code'] ?>">
                                    </div>

                                    <div class="col-span-6">
                                        <label for="about" class="block text-sm font-medium text-white"> About You </label>
                                        <div class="mt-1">
                                            <textarea id="about" name="about" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 px-2 py-1 block w-full sm:text-sm border border-gray-300 bg-pink-300 rounded-md" placeholder="you@example.com" value="<?php echo $d['about'] ?>"></textarea>
                                        </div>
